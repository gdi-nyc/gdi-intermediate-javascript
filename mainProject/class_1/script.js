...
// BONUS //
///////////
// Abstract the randomized index into its own function called "random",
// which takes a number argument and returns an integer between 0 (inclusive) 
// and the given number (exclusive)

// Add a .scramble() method to the Array class (use prototyping) that randomly 
// rearrangles the given array's items